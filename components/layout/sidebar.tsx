    ...
    <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 bg-card border-r border-border">
      ...
      <div className="p-4 border-t border-border space-y-3">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <a href="https://t.me/NexvoraWebtools" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors" title="Telegram Channel">
