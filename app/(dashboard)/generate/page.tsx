    ...
    <div className="max-w-4xl mx-auto">
      ...
      {!apiKey && (
        <div className="mb-4 p-4 rounded-lg border border-primary/30 bg-primary/5">
          ...
          <p className="text-xs text-muted-foreground mt-1">Masukkan API key di tombol &quot;API Key&quot; di header atas, atau dapatkan gratis di <a href="https://www.magnific.com/api" target="_blank" rel="noopener noreferrer" className="text-primary underline">magnific.com/api</a></p>
        </div>
      )}
      {/* Page Header */}
